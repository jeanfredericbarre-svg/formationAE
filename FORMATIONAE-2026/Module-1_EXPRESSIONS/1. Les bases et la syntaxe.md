...
Le **pickwhip** (le "fouet") est l'outil le plus rapide pour créer un lien entre deux propriétés sans écrire une expression à la main. Il génère automatiquement le code nécessaire pour qu'une propriété suive la valeur d'une autre.
