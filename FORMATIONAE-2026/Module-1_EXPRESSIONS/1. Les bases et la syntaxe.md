...
## C'est quoi une Expression ? <span id="cestquoi"></span>
...
> 💡 Analogie : une keyframe dit : "à ce moment précis, la valeur est X" et c'est l'utilisateur qui définit cette valeur. Une expression dit *"calcule toi-même la valeur en fonction de règles"*.
...
<div class="ae-download">
  ...
  <div class="ae-download__body">
    ...
    <span class="ae-download__name">Module-1_01-bases.aep</span>
    <span class="ae-download__desc">Fichier de départ pour tester les expressions</span>
  </div>
  <a class="ae-download__btn" href="https://drive.google.com/uc?export=download&id=1_comneBokceQxYR_2llN5PLbnimxQL_4">Télécharger</a>
</div>

## JavaScript dans AE <span id="javascript"></span>
...
## 2 sources essentielles <span id="ressources"></span>
