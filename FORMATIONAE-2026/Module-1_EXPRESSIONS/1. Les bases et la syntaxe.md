...
> 💡 Analogie : une image clée dit : "à ce moment précis, la valeur est X" et c'est l'utilisateur qui définit cette valeur. Une expression dit *"calcule toi-même la valeur en fonction de règles"*.
___
